...
// helpdesk support email id and support name (Example: 'support@ictpioneers.ir' and 'vtiger support')
$HELPDESK_SUPPORT_EMAIL_ID = 'support@ictpioneers.ir';
...
// root directory path
$root_directory = getenv('root_directory') ?? '/var/www/html/';
