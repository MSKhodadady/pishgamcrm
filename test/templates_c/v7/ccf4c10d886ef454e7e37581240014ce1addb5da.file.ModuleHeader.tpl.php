<?php /* Smarty version Smarty-3.1.7, created on 2023-05-27 12:01:46
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/crm/version 7.1.2 FA/onRun/includes/runtime/../../layouts/v7/modules/Settings/Vtiger/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4571355016471f12a9e8727-00463026%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ccf4c10d886ef454e7e37581240014ce1addb5da' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/crm/version 7.1.2 FA/onRun/includes/runtime/../../layouts/v7/modules/Settings/Vtiger/ModuleHeader.tpl',
      1 => 1527255090,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4571355016471f12a9e8727-00463026',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6471f12aa3f5f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6471f12aa3f5f')) {function content_6471f12aa3f5f($_smarty_tpl) {?>
...
" href='index.php?module=Vtiger&parent=Settings&view=Index'><h4 class="module-title pull-left text-uppercase"><?php echo vtranslate('LBL_HOME',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </h4></a>&nbsp;<span class="fa fa-angle-left pull-left <?php if ($_smarty_tpl->tpl_vars['VIEW']->value=='Index'&&$_smarty_tpl->tpl_vars['MODULE']->value=='Vtiger'){?> hide <?php }?>" aria-hidden="true" style="padding-top: 12px;padding-left: 5px; padding-right: 5px;"></span><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='Vtiger'||$_REQUEST['view']!='Index'){?><?php if ($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block']){?><span class="current-filter-name filter-name pull-left"><?php echo vtranslate($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block'],$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<span class="fa fa-angle-left" aria-hidden="true"></span>&nbsp;</span><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='Vtiger'){?><?php $_smarty_tpl->tpl_vars['ALLOWED_MODULES'] = new Smarty_variable(explode(",",'Users,Profiles,Groups,Roles,Webforms,Workflows'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value&&in_array($_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['ALLOWED_MODULES']->value)){?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Webforms'){?><?php $_smarty_tpl->tpl_vars['URL'] = new Smarty_variable($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getListViewUrl(), null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['URL'] = new Smarty_variable($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getDefaultUrl(), null, 0);?><?php }?><?php if (strpos($_smarty_tpl->tpl_vars['URL']->value,'parent')==''){?><?php $_smarty_tpl->tpl_vars['URL'] = new Smarty_variable((($_smarty_tpl->tpl_vars['URL']->value).('&parent=')).($_REQUEST['parent']), null, 0);?><?php }?><?php }?><span class="current-filter-name settingModuleName filter-name pull-left"><?php if ($_REQUEST['view']=='Calendar'){?><?php if ($_REQUEST['mode']=='Edit'){?><a href="<?php echo ((((("index.php?module=").($_REQUEST['module'])).('&parent=')).($_REQUEST['parent'])).('&view=')).($_REQUEST['view']);?>
...
</a>&nbsp;<span class="fa fa-angle-left" aria-hidden="true"></span>&nbsp;<?php echo vtranslate('LBL_EDITING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 :&nbsp;<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['PAGETITLE']->value;?>
...
&nbsp;<span class="fa fa-angle-left" aria-hidden="true"></span>&nbsp;<?php echo $_smarty_tpl->tpl_vars['USER_MODEL']->value->getName();?>
...
<?php }?>&nbsp;</a><span class="fa fa-angle-left" aria-hidden="true"></span>&nbsp;<?php if ($_REQUEST['view']=='Edit'){?><?php if ($_smarty_tpl->tpl_vars['RECORD']->value){?><?php echo vtranslate('LBL_EDITING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }?></a>&nbsp;<span class="fa fa-angle-left" aria-hidden="true"></span>&nbsp;<?php if ($_smarty_tpl->tpl_vars['RECORD']->value){?><?php if ($_REQUEST['view']=='Edit'){?><?php echo vtranslate('LBL_EDITING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" aria-hidden="true"></div><span class="hidden-sm hidden-xs">&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span></button><?php }else{ ?><button type="button" class="btn addButton btn-default module-buttons"id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
"'<?php }?><?php }?>><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Tags'){?><i class="fa fa-plus"></i><span class="hidden-sm hidden-xs">&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_TAG',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->value->getIcon()){?><i class="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->value->getIcon();?>
"></i><?php }?><span class="hidden-sm hidden-xs">&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span><?php }?></button></li><?php } ?><?php }?></ul></div></div></div><?php if ($_smarty_tpl->tpl_vars['FIELDS_INFO']->value!=null){?><script type="text/javascript">var uimeta = (function () {var fieldInfo = <?php echo $_smarty_tpl->tpl_vars['FIELDS_INFO']->value;?>
