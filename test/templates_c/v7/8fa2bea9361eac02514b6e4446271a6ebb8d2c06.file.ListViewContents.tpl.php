<?php /* Smarty version Smarty-3.1.7, created on 2023-07-30 13:10:03
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/crm/version 7.1.2 FA/onRun/includes/runtime/../../layouts/v7/modules/Settings/Workflows/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:71908150764c6612b7598d3-93673833%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8fa2bea9361eac02514b6e4446271a6ebb8d2c06' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/crm/version 7.1.2 FA/onRun/includes/runtime/../../layouts/v7/modules/Settings/Workflows/ListViewContents.tpl',
      1 => 1534519390,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '71908150764c6612b7598d3-93673833',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_64c6612bb9148',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_64c6612bb9148')) {function content_64c6612bb9148($_smarty_tpl) {?>
...
<?php }else{ ?>0<?php }?>'><?php if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getName()=='Calendar'){?><?php echo vtranslate('LBL_WORKFLOWS');?>
&nbsp;<?php echo vtranslate('LBL_TASK',$_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getName());?>
<?php }else{ ?><?php echo vtranslate('LBL_WORKFLOWS');?>
...
" style="vertical-align:inherit !important;"><?php $_smarty_tpl->tpl_vars['SINGLE_MODULE'] = new Smarty_variable("SINGLE_".($_smarty_tpl->tpl_vars['MODULE']->value), null, 0);?><center><?php echo vtranslate('LBL_NOTHING');?>
 <?php echo vtranslate($_smarty_tpl->tpl_vars['SINGLE_MODULE']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
