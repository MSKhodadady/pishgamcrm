<?php /* Smarty version Smarty-3.1.7, created on 2023-05-27 12:51:13
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/crm/version 7.1.2 FA/onRun/includes/runtime/../../layouts/v7/modules/Reports/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18870711536471fcc159af04-24279017%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8b79db7adfd8b10740250e8c9b2f0bb488e10d16' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/crm/version 7.1.2 FA/onRun/includes/runtime/../../layouts/v7/modules/Reports/ModuleHeader.tpl',
      1 => 1527254918,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18870711536471fcc159af04-24279017',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6471fcc15bc9f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6471fcc15bc9f')) {function content_6471fcc15bc9f($_smarty_tpl) {?>
...
&nbsp;</h4></a></span><span><p class="current-filter-name pull-left">&nbsp;<span class="fa fa-angle-left" aria-hidden="true"></span>&nbsp;<?php if ($_smarty_tpl->tpl_vars['VIEW']->value=='Detail'||$_smarty_tpl->tpl_vars['VIEW']->value=='ChartDetail'){?><?php echo $_smarty_tpl->tpl_vars['REPORT_NAME']->value;?>
...
_listView_basicAction_Add"><i class="fa fa-plus"></i><span class="hidden-sm hidden-xs">&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span>&nbsp;<i class="caret icon-white"></i></button><ul class="dropdown-menu"><?php  $_smarty_tpl->tpl_vars["childLink"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["childLink"]->_loop = false;
...
;return {field: {get: function (name, property) {if (name && property === undefined) {return fieldInfo[name];}if (name && property) {return fieldInfo[name][property]}},isMandatory: function (name) {if (fieldInfo[name]) {return fieldInfo[name].mandatory;}return false;},getType: function (name) {if (fieldInfo[name]) {return fieldInfo[name].type}return false;}}};})();</script><?php }?><div class="rssAddFormContainer hide"></div></div>
<?php }} ?>