...
class RecurringType {
	...
	public static function fromUserRequest($requestArray) {
		...
		$requestArray['startdate']=jalToGre($requestArray['startDate']);
		$requestArray['enddate']=jalToGre($requestArray['enddate']);
		$requestArray['recurringenddate']=jalToGre($requestArray['recurringenddate']);
