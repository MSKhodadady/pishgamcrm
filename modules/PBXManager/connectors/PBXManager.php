...
class PBXManager_PBXManager_Connector {
    ...
    // Jweb.ir begin hide trunk field
    ...
    public function handleStartupCall($details, $userInfo, $customerInfo) {
        ...
        // Jweb.ir begin Set user timezone for starttime param
        $params['starttime'] = $details->get('StartTime');
        // Jweb.ir end
        ...
        //Jweb.ir begin fix multiplication on call transfer
        ...
        //Jweb.ir begin delete no-need code
        //if ($direction == self::INCOMING_TYPE)
