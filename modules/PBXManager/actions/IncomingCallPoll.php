    ...
    public function searchIncomingCalls(Vtiger_Request $request){
        ...
        if($recordModels){
            foreach ($recordModels as $recordModel){
                ...
                if(!$callerid){
                   $customerData = $recordModel->lookUpRelatedWithNumber($recordModel->get('customernumber'));
                   $callerid = $customerData['id'];
                   $recordModel->set('customer',$customerData['id']);
                   $recordModel->set('customertype',$customerData['setype']);
                }
