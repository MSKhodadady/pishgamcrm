...
function addCompany( $nom, $address, $location='' )
{
	...
	$this->SetXY( $x1, $y1 );
	$this->SetFont('mitra','B',12);
	$length = $this->GetStringWidth( $nom );
	$this->Cell( $length, 2, $nom);
	$this->SetXY( $x1, $y1 + 4 );
	$this->SetFont('mitra','',10);
