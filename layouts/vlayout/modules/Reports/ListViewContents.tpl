		...
		<tbody>
			<tr>
				<td>
					...
					{vtranslate('LBL_NOTHING')} {vtranslate($SINGLE_MODULE, $MODULE)}{vtranslate('LBL_PY')} {vtranslate('LBL_NOT_FOUND')}. {vtranslate('LBL_CREATE')} <a href="{$MODULE_MODEL->getCreateRecordUrl()}&folderid={$VIEWNAME}">{vtranslate($SINGLE_MODULE, $MODULE)}</a>
				</td>
			</tr>
		</tbody>
	</table>
