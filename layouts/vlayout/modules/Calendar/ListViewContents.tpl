		...
		<tbody>
			<tr>
				<td>
					...
					{vtranslate('LBL_NOTHING')} {vtranslate($SINGLE_MODULE, $MODULE)}{vtranslate('LBL_PY')} {vtranslate('LBL_NOT_FOUND')}.{if $IS_RECORD_CREATABLE} {vtranslate('LBL_CREATE')} <a href="{$MODULE_MODEL->getCreateRecordUrl()}">{vtranslate($SINGLE_MODULE, $MODULE)}</a>{/if}
				</td>
			</tr>
		</tbody>
	</table>
