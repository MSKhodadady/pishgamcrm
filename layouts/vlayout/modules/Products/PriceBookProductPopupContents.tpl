...
<div class="popupEntriesDiv relatedContents contents-bottomscroll">
  ...
  {assign var=SINGLE_MODULE value="SINGLE_$MODULE_NAME"}
		<div class="row-fluid">
			<div class="emptyRecordsDiv">{vtranslate('LBL_NOTHING', $MODULE_NAME)} {vtranslate($SINGLE_MODULE, $MODULE_NAME)}{vtranslate('LBL_PY')} {vtranslate('LBL_NOT_FOUND', $MODULE_NAME)}.</div>
		</div>
	{/if}
</div>
