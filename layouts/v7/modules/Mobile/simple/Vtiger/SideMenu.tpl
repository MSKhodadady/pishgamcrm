...
<md-sidenav class="md-sidenav-right" md-component-id="left">
    <md-toolbar class="app-menu md-locked-open">
        ...
        <div class="app-dropdown">
            <md-select ng-model="selectedApp" aria-label="app_menu">
                <md-option ng-repeat="app in apps" ng-value="app.name" ng-click="setSelectedApp(app.name)">{{app.label}}</md-option>
            </md-select>
        </div>
    </md-toolbar>
    ...
    <md-list>
        <md-list-item md-ink-ripple class="md-1-line">
            <div class="md-list-item-text">
                <a href="#" class="logout-link" ng-click="logout();"><span class="mdi mdi-power"></span>&nbsp; خروج</a>
            </div>
        </md-list-item>
