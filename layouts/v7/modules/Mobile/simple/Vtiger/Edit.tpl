    ...
    <header md-page-header fixed-top>
        <md-toolbar>
            <div class="md-toolbar-tools actionbar">
                ...
                <h2 ng-if="record" flex>ویرایش</h2>
                <h2 ng-if="!record" flex>ایجاد</h2>
                <span flex></span>
                    ...
                    <div class="md-list-item-text field-row" ng-switch="field.type.name">
                        <md-input-container ng-switch-when="string">
                            ...
                            <div ng-messages="editForm.{{field.name}}.$error">
                                <div ng-show="field.mandatory && !field.raw" ng-message="required"> این فیلد الزامی می باشد.</div>
                            </div>
                        </md-input-container>
                        <md-input-container ng-switch-when="phone">
                            ...
                            <div ng-messages="editForm.{{field.name}}.$error">
                                <div ng-if="editForm[field.name].$error.required"  ng-message="required"> این فیلد الزامی می باشد.</div>
                            </div>
                        </md-input-container>
                        <!--*************PICKLIST UI***********************************-->
                        ...
                        <md-input-container ng-switch-when="boolean">
                            ...
                            <div ng-messages="editForm.{{field.name}}.$error">
                                <div ng-show="field.mandatory" ng-message="required"> این فیلد الزامی می باشد.</div>
                            </div>
                        </md-input-container>
                        <!--************* TEXT AREA *********************-->
