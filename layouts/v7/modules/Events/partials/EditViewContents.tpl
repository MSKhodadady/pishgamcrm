	...
	<div name='editContent'>
		<div class='fieldBlockContainer' data-block="{$BLOCK_LABEL}">
			...
			<div class="table table-borderless">
				<div class="row">
					<div class="fieldLabel alignMiddle col-md-3 col-sm-12 col-xs-12">{vtranslate('LBL_INVITE_USERS', $MODULE)}</div>
					<div class="fieldValue col-md-3 col-sm-12 col-xs-12">
					...
					<div class=" col-md-3 col-sm-12 col-xs-12"></div><div class=" col-md-3 col-sm-12 col-xs-12"></div>
				</div>
			</div>
