    ...
    <div class="popupEntriesDiv relatedContents contents-bottomscroll">
        ...
        <div class="bottomscroll-div">
            ...
            {if $LISTVIEW_ENTRIES_COUNT eq '0'}
                ...
                {else}
                    {assign var=SINGLE_MODULE value="SINGLE_$RELATED_MODULE"}
                    <div class="emptyRecordsDiv">{vtranslate('LBL_NOTHING', $MODULE)} {vtranslate($SINGLE_MODULE, $RELATED_MODULE)}{vtranslate('LBL_PY')} {vtranslate('LBL_NOT_FOUND', $MODULE)}.</div>
                {/if}
            {/if}
        </div>
    </div>
