                        ...
                        <div class="massEditTable table no-border">
                            <div class="row">
                                ...
                                {foreach key=FIELD_NAME item=FIELD_MODEL from=$RECORD_STRUCTURE name=blockfields}
                                    ...
                                    {/if}
                                    <div class='fieldLabel col-lg-2 col-md-2 col-xs-4 col-sm-4'>
                                    ...
                                    {if $FIELD_MODEL->get('uitype') neq '83'}
                                        <div class="fieldValue col-lg-4 col-md-4 col-xs-8 col-sm-8" {if $FIELD_MODEL->get('uitype') eq '19'} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}>
