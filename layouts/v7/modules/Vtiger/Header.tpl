...
<html dir="rtl" ff="ff">
	<head>
		...
		<link type='text/css' rel='stylesheet' href='layouts/v7/lib/todc/css/bootstrap-rtl.css'>
		...
		<link type='text/css' rel='stylesheet' href='resources/styles-rtl.css'>
	</head>
	...
	<input type="hidden" id="persianvt_calendar_type" value="jalali">
