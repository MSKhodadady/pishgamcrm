...
Vtiger.Class("Vtiger_Detail_Js",{
	...
	*/
	...
	registerAjaxEditEvent : function(){
		var thisInstance = this;
		var detailContentsHolder = this.getContentHolder();
		detailContentsHolder.on('click','div.detailview-table div.fieldValue .editAction', function(e) {
			var editedLength = jQuery('div.detailview-table div.fieldValue .ajaxEdited').length;
			if(editedLength === 0) {
