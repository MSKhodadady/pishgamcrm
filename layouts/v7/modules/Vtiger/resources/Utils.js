...
var vtUtils = {
    ...
    registerEventForDateFields : function(parent, params) {
        ...
        var datepickerFormat = app.convertToDatePickerJformat(userDateFormat)
            ...
            jQuery(element).each(function(index, Elem){
                element = jQuery(Elem);
                 if(calendarType == "range"){
                    ...
                    element.daterangepicker(defaultPickerParams);
                    element.on('apply.daterangepicker', function (ev, picker) {
    ...
    getMomentDateFormat : function() {
     ...
     getJMomentDateFormat : function() {
        var dateFormat = app.getDateFormat();
        return app.convertToDatePickerJformat(dateFormat);
    },
