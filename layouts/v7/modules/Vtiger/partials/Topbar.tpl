...
{strip}
	...
	<nav class="navbar navbar-default navbar-fixed-top app-fixed-navbar">
		<div class="container-fluid global-nav">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-7 paddingLeft0 app-navigator-container">
					<div class="row">
						...
						<li>
							<div class="dropdown">
								...
								<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="width:500px;">
									<li class="title" style="padding: 5px 15px 0 15px;">
													...
													{if $quickCreateModule == '1'}
														{if $count % 3 == 0}
															...
															{if $singularLabel == 'SINGLE_Calendar'}
																...
																<div class="{if $hideDiv}create_restricted_{$moduleModel->getName()} hide{else}col-lg-4 col-md-4 col-sm-4{/if}">
															...
															{else if $singularLabel == 'SINGLE_Documents'}
																<div class="{if $hideDiv}create_restricted_{$moduleModel->getName()} hide{else}col-lg-4 col-md-4 col-sm-4{/if} dropdown">
			   ...
			   <div class="dropdown btn-group pull-right">
			      <button style="background-color: #2C3B49;padding: 12px;color: #fff;margin-top: -1px;margin-bottom:0px;border: none;border-left: 1px solid #fff; " class="btn dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="true"><i class="fa fa-gear"></i>&nbsp;<span class="caret"></span></button>
			      <ul class="dropdown-menu">
							{assign var=USER_PRIVILEGES_MODEL value=Users_Privileges_Model::getCurrentUserPrivilegesModel()}
							{assign var=CALENDAR_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Calendar')}
							{if $USER_PRIVILEGES_MODEL->hasModulePermission($CALENDAR_MODULE_MODEL->getId())}
								<li><a href="index.php?module=Calendar&view={$CALENDAR_MODULE_MODEL->getDefaultViewName()}" title="Calendar" aria-hidden="true"><i class="fa fa-calendar"></i>&nbsp;{vtranslate('Calendar','Calendar')}</a></li>
							{/if}
							{assign var=REPORTS_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Reports')}
							{if $USER_PRIVILEGES_MODEL->hasModulePermission($REPORTS_MODULE_MODEL->getId())}
							...
							{/if}
							{if $USER_PRIVILEGES_MODEL->hasModulePermission($CALENDAR_MODULE_MODEL->getId())}
								<li><a href="#" class="taskManagement" title="{vtranslate('Tasks','Vtiger')}" aria-hidden="true"><i class="vicon vicon-task"></i>&nbsp;{vtranslate('Tasks','Vtiger')}</a></li>
							{/if}
			         <li class="divider"></li>
			         <li class="dropdown-header">{$USER_MODEL->get('last_name')}<br>{$USER_MODEL->getUserRoleName()}</li>
			         <li class="divider"></li>
			         <li><a id="menubar_item_right_LBL_MY_PREFERENCES" href="{$USER_MODEL->getPreferenceDetailViewUrl()}"><i class="fa fa-cogs"></i>&nbsp;{vtranslate('LBL_MY_PREFERENCES')}</a></li>
			         <li><a id="menubar_item_right_LBL_SIGN_OUT" href="index.php?module=Users&action=Logout"><i class="fa fa-power-off"></i>&nbsp;{vtranslate('LBL_SIGN_OUT')}</a></li>
			      </ul>
			   </div>
			</div>
			<!-- ictpioneers -->
