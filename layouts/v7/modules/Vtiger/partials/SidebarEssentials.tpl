...
<div class="sidebar-menu">
				...
				<div class="list-menu-content">
					...
					{/foreach}
                        ...
                        <div class="list-group hide noLists">
                            <h6 class="lists-header"><center> {vtranslate('LBL_NOTHING')} {vtranslate('LBL_LIST')}{vtranslate('LBL_PY')} {vtranslate('LBL_NOT_FOUND')} ... </center></h6>
                        </div>
                </div>
            </div>
        </div>
    ...
    {/if}
    {if $MODULE == 'SMSNotifier'}
    {assign var=ACTIVE_SMSSERVICE value=SMSNotifier_ServiceInfo_View::getServiceInfo()}
