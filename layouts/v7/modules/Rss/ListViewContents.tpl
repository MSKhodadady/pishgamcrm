						...
						<div class="row-fluid detailViewButtoncontainer">
							<span class="btn-toolbar pull-right">
								<span class="btn-group">
									<button id="deleteButton" class="btn btn-default"><i class="fa fa-trash"></i><span class="hidden-sm hidden-xs">&nbsp;&nbsp;
										{vtranslate('LBL_DELETE', $MODULE)}</span></button>
									<button id="makeDefaultButton" class="btn btn-default"><i class="fa fa-lightbulb"></i>
										<span class="hidden-sm hidden-xs">&nbsp;&nbsp;
										{vtranslate('LBL_SET_AS_DEFAULT', $MODULE)}</span></button>
								</span>
							</span>
							...
							<tbody>
								<tr>
									<td>
										...
										{vtranslate('LBL_NOTHING')} {vtranslate($SINGLE_MODULE, $MODULE)}{vtranslate('LBL_PY')} {vtranslate('LBL_NOT_FOUND')}. {vtranslate('LBL_CREATE')}<a class="rssAddButton" href="#" data-href="{$QUICK_LINKS['SIDEBARLINK'][0]->getUrl()}">&nbsp;{vtranslate($SINGLE_MODULE, $MODULE)}</a>
									</td>
								</tr>
							</tbody>
						</table>
