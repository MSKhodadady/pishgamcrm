...
{strip}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6 controls">
            ...
            <span><input type="radio" name="workflow_trigger" value="1" {if $EXECUTION_CONDITION eq '1'} checked="" {/if}> <span id="workflowTriggerCreate">{vtranslate('LBL_CREATION', $QUALIFIED_MODULE)} {vtranslate($SINGLE_SELECTED_MODULE, $SELECTED_MODULE)}</span></span><br>
            <span><input type="radio" name="workflow_trigger" value="3" {if $EXECUTION_CONDITION eq '3' or $EXECUTION_CONDITION eq '2'} checked="" {/if}> <span id="workflowTriggerUpdate">{vtranslate('LBL_UPDATED', $QUALIFIED_MODULE)} {vtranslate($SINGLE_SELECTED_MODULE, $SELECTED_MODULE)} </span> &nbsp;({vtranslate('LBL_INCLUDES_CREATION', $QUALIFIED_MODULE)})</span><br>
