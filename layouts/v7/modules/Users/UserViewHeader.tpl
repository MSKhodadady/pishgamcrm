                ...
                <div class="pull-right col-md-7 detailViewButtoncontainer">
                    <div class="btn-group pull-right">
                        ...
                        {if $DETAILVIEW_LINKS['DETAILVIEW']|@count gt 0}
                            <button class="btn btn-default" data-toggle="dropdown" href="javascript:void(0);"><span class="hidden-sm hidden-xs">&nbsp;&nbsp;
                             {vtranslate('LBL_MORE', $MODULE)}</span>&nbsp;&nbsp;<i class="caret"></i>
                            </button>
