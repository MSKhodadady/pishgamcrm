...
{strip}
	<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix">
			<div class="col-xs-12 col-sm-7 col-lg-7 col-md-7 module-breadcrumb">
				<span>
				...
				{if $VIEWID}
					...
					{/foreach}
					<span>
						<p class="current-filter-name filter-name pull-left"><span class="fa fa-angle-left" aria-hidden="true"></span>&nbsp;{$CVNAME}&nbsp;</p>
					</span>
				{/if}
			</div>
					...
					<ul class="nav navbar-nav">
						...
						<li>
							<button class="btn btn-default addBookmark addButton module-buttons" >
								<i class="fa fa-plus"></i><span class="hidden-sm hidden-xs">&nbsp;&nbsp;{vtranslate('LBL_ADD_BOOKMARK',$MODULE)}</span>
							</button>
						</li>
					</ul>
				</div>
